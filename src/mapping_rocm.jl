# DFT_to_beta
function DFT_to_beta_1d!(beta::ROCVector{Float64}, v::ROCVector{ComplexF64}, size; rdft::Bool=false)
    N = size[1]
    M = N ÷ 2
...
function DFT_to_beta_2d!(beta::ROCVector{Float64}, v::ROCMatrix{ComplexF64}, size; rdft::Bool=false)
    N1 = size[1]
    N2 = size[2]
    M1 = N1 ÷ 2
    M2 = N2 ÷ 2
...
function DFT_to_beta_3d!(beta::ROCVector{Float64}, v::ROCArray{ComplexF64,3}, size; rdft::Bool=false)
    N1 = size[1]
    N2 = size[2]
    N3 = size[3]
    M1 = N1 ÷ 2
...
# beta_to_DFT
function beta_to_DFT_1d!(v::ROCVector{ComplexF64}, beta::AMDGPU.StridedROCVector{Float64}, size; rdft::Bool=false)
    N = size[1]
    M = N ÷ 2
...
function beta_to_DFT_2d!(v::ROCMatrix{ComplexF64}, beta::AMDGPU.StridedROCVector{Float64}, size; rdft::Bool=false)
    N1 = size[1]
    N2 = size[2]
    M1 = N1 ÷ 2
    M2 = N2 ÷ 2
...
function beta_to_DFT_3d!(v::ROCArray{ComplexF64, 3}, beta::AMDGPU.StridedROCVector{Float64}, size; rdft::Bool=false)
    N1 = size[1]
    N2 = size[2]
    N3 = size[3]
    M1 = N1 ÷ 2
